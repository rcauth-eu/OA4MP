...
public class ClaimsProcessor {
    ...
    public Map<String, Object> process(Map<String, Object> claims) {
        ServletDebugUtil.info(this, "starting processing");

        if(config == null || config.isEmpty()){
            ServletDebugUtil.info(this, "NO configuration, returning.");
            return claims;
        }

        logicBlocks = createLogicBlocks(config, claims);
        ServletDebugUtil.info(this, "created " + logicBlocks.size() + " logic blocks.");
        logicBlocks.execute();
        executed = true;
        ServletDebugUtil.info(this, "Finished processing, returned claims are");
        ServletDebugUtil.info(this, claims.toString());
    ...
    protected LogicBlocks<? extends LogicBlock> createLogicBlocks(JSONObject configuration,
        ...
        ServletDebugUtil.info(this, "config:\n\n" + config.toString(2));
        ...
        ServletDebugUtil.info(this, "created logic blocks:\n\n" + j.toString(2));
